...
class keywordsDemo {
	...
	def cura_login() {
		WebUiBuiltInKeywords.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Username_username'), 'John Doe')

		WebUiBuiltInKeywords.setEncryptedText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Password_password'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')
	...
	public void captureScreenshot() throws IOException{
		...
		ImageIO.write(screenshot.getImage(),"jpg",new File("./fullPageScreenshot.jpg"));
	}
